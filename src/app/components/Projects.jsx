...
export default function Projects() {
  return (
    <div id="projects" className="projects py-11 my-30 border border-cyan-300 dark:border-slate-300/11 rounded-lg ">
      ...
      {/*cards*/}
        <Tilt tiltMaxAngleX={11} tiltMaxAngleY={11}>
          <div className="w-96 p-3 rounded-lg border-2 border-primaryl-100 dark:border-secondary-100/30 bg-cyan-200 dark:bg-slate-950">
              ...
              <div className="text-center mt-3 p-4">
                ...
                <div className="flex flex-wrap mt-3 gap-3 justify-center w-full">
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-3 rounded-lg font-semibold text-primary-100 dark:text-black">Demo</button>
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-3 rounded-lg font-semibold text-primary-100 dark:text-black">Source code</button>
                </div>
              </div>
          </div>
        </Tilt>
