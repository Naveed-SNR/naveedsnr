          ...
          <div className="w-83 p-3 rounded-lg border-2 border-primaryl-100 dark:border-secondary-100/30 bg-cyan-200 dark:bg-slate-950">
              ...
              <div className="text-center mt-3 p-4">
                ...
                <div className="flex flex-wrap mt-3 gap-3 justify-center w-full">
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-2 rounded-lg text-sm md:text-md 2xl:text-base font-semibold text-primary-100 dark:text-black button-animation glow-subtle">Demo</button>
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-2 rounded-lg text-sm md:text-md 2xl:text-base font-semibold text-primary-100 dark:text-black button-animation glow-subtle">Source code</button>
                </div>
              </div>
          </div>
        </Tilt>
        ...
        <Tilt tiltMaxAngleX={3.8} tiltMaxAngleY={3.8}>
          <div className="w-83 p-3 rounded-lg border-2 border-primaryl-100 dark:border-secondary-100/30 bg-cyan-200 dark:bg-slate-950">
              ...
              <div className="text-center mt-3 p-4">
                ...
                <div className="my-8.3 md:my-9.2 font-medium text-md text-secondaryl-100 dark:text-secondary-100">Travel website built using Next.js, Firebase and Stripe (for payments)
                </div>
                <div className="flex flex-wrap mt-3 gap-3 justify-center w-full">
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-2 rounded-lg text-sm md:text-md 2xl:text-base font-semibold text-primary-100 dark:text-black button-animation glow-subtle">Demo</button>
                  <button className="bg-primaryl-100 dark:bg-primary-100/83 w-5/12 py-2 px-2 rounded-lg text-sm md:text-md 2xl:text-base font-semibold text-primary-100 dark:text-black button-animation glow-subtle">Source code</button>
