...
export default function Home() {
  ...
  return (
    <>
      <div className="home">
        <motion.div className="lg:mt-74 shrink flex lg:flex-nowrap flex-wrap-reverse items-center lg:justify-between justify-center lg:space-x-48 w-full lg:border-l border-gray-800">
